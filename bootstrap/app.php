...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->web(append: [App\Http\Middleware\SeparatePortalAccess::class, App\Http\Middleware\StaffAccess::class, App\Http\Middleware\FilterUnauthorizedWebActions::class]);
